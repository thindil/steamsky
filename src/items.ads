...
-- ****
   ...
   -- ****t* Items/Items.Inventory_Sort_Orders
   -- FUNCTION
   ...
   -- ****f* Items/Items."<"
   -- FUNCTION
   -- Provide sorting for items in various inventories
   -- PARAMETERS
   -- Left  - The left item to compare
   -- Right - The right item to compare
   -- RESULT
   -- If left item should go first return True, otherwise False
   -- HISTORY
   -- 6.4 - Added
   -- SOURCE
   ...
   -- ****t* Items/Items.Inventory_Sorting
   -- FUNCTION
   -- Used to sort items in various inventories
   -- HISTORY
   -- 6.4 - Added
   -- SOURCE
