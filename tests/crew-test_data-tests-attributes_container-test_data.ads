...
package Crew.Test_Data.Tests.Attributes_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Crew.Attributes_Container.Test_Data (Test);
...
end Crew.Test_Data.Tests.Attributes_Container.Test_Data;
