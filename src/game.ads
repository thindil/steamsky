...
package Game is
    ...
    type GameStates is (Quit, Main_Menu, Sky_Map_View, Control_Speed,
        ...
        Help_View, Quit_Confirm, New_Game, Combat_State, Combat_Orders, 
        Craft_View, License_Info, License_Full, Wait_Order, News_View, 
        ...
        GameMenu, GameStats_View, Death_Confirm, TradeRecipes_View); -- Game states
    ...
    GameVersion : constant String := "Version: 0.7";
