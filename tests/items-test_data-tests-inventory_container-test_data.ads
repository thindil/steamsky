...
package Items.Test_Data.Tests.Inventory_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Items.Inventory_Container.Test_Data (Test);
