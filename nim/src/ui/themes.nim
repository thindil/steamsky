...
proc setTheme*() {.sideEffect, raises: [], tags: [WriteIOEffect, TimeEffect].} =
  ...
  tclEval(script = mainPaned & ".mapframe.buttons.n configure -image arrowupicon")
  tclEval(script = mainPaned & ".controls.buttons.n configure -image arrowupicon")
  tclEval(script = mainPaned & ".mapframe.buttons.s configure -image arrowdownicon")
  tclEval(script = mainPaned & ".controls.buttons.s configure -image arrowdownicon")
  tclEval(script = mainPaned & ".mapframe.buttons.w configure -image arrowlefticon")
  tclEval(script = mainPaned & ".controls.buttons.w configure -image arrowlefticon")
  tclEval(script = mainPaned & ".mapframe.buttons.e configure -image arrowrighticon")
  tclEval(script = mainPaned & ".controls.buttons.e configure -image arrowrighticon")
  tclEval(script = mainPaned & ".mapframe.buttons.nw configure -image arrowuplefticon")
  ...
  tclEval(script = mainPaned & ".mapframe.buttons.sw configure -image arrowdownlefticon")
...
proc getAdaIcon(name: cstring): cstring {.raises: [], tags: [WriteIOEffect, TimeEffect], exportc.} =
  ...
  of "studyColoredIcon":
    return theme.studyColoredIcon.cstring
  of "deconstructColoredIcon":
    return theme.deconstructColoredIcon.cstring
  of "giveOrderColoredIcon":
  ...
  of "expandIcon":
    return theme.expandIcon.cstring
  of "contractIcon":
    return theme.contractIcon.cstring
  of "moreOptionsIcon":
    return theme.moreOptionsIcon.cstring
  else:
