...
package Missions.Test_Data.Tests.Mission_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Missions.Mission_Container.Test_Data (Test);
...
end Missions.Test_Data.Tests.Mission_Container.Test_Data;
