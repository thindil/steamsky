...
wm geometry . 800x600+[expr ([winfo vrootwidth .] - 800) / 2]+[expr \
   ([winfo vrootheight .] - 600) / 2]
pack [ttk::label .generalinfo \
...
pack [text .technical.text -wrap word \
   -yscrollcommand [list .technical.scroll set]] -fill both -expand true \
   -side top
