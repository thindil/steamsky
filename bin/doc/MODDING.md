...
* Inside help text you can use special variables which later will be replaced
  ...
  show knowledge info, show accepted missions, show know stories, move map
  position, show game statistics, show help, show game options, quit from
  game, resign from game, show menu, show wait orders, zoom out, zoom in.
