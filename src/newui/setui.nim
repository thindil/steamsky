...
var
  ...
  generalKeysOptions*: array[4, string] = ["", "", "", ""]
...
proc setMapKeys*() {.raises: [], tags: [], contractual.} =
  ...
  mapKeysOptions[10] = mapAccelerators[25]
  mapKeysOptions[11] = mapAccelerators[26]
  mapKeysOptions[12] = mapAccelerators[27]
  mapKeysOptions[13] = mapAccelerators[28]
  mapKeysOptions[14] = mapAccelerators[29]
  mapKeysOptions[15] = mapAccelerators[30]
  mapKeysOptions[16] = mapAccelerators[31]
  mapKeysOptions[17] = mapAccelerators[32]
  mapKeysOptions[18] = mapAccelerators[33]
...
proc updateOptions*() {.raises: [], tags: [], contractual.} =
  ...
  menuAccelerators[1] = menuKeysOptions[0]
  menuAccelerators[2] = menuKeysOptions[1]
  menuAccelerators[3] = menuKeysOptions[2]
  menuAccelerators[4] = menuKeysOptions[3]
  menuAccelerators[5] = menuKeysOptions[4]
  menuAccelerators[6] = menuKeysOptions[5]
  menuAccelerators[7] = menuKeysOptions[6]
  menuAccelerators[8] = menuKeysOptions[7]
  menuAccelerators[9] = menuKeysOptions[8]
  menuAccelerators[10] = menuKeysOptions[9]
  menuAccelerators[11] = menuKeysOptions[10]
  mapAccelerators[1] = menuKeysOptions[11]
  mapAccelerators[15] = mapKeysOptions[0]
  mapAccelerators[16] = mapKeysOptions[1]
  mapAccelerators[20] = mapKeysOptions[2]
  mapAccelerators[21] = mapKeysOptions[3]
  mapAccelerators[18] = mapKeysOptions[4]
  mapAccelerators[23] = mapKeysOptions[5]
  mapAccelerators[17] = mapKeysOptions[6]
  mapAccelerators[19] = mapKeysOptions[7]
  mapAccelerators[22] = mapKeysOptions[8]
  mapAccelerators[24] = mapKeysOptions[9]
  mapAccelerators[25] = mapKeysOptions[10]
  mapAccelerators[26] = mapKeysOptions[11]
  mapAccelerators[27] = mapKeysOptions[12]
  mapAccelerators[28] = mapKeysOptions[13]
  mapAccelerators[29] = mapKeysOptions[14]
  mapAccelerators[30] = mapKeysOptions[15]
  mapAccelerators[31] = mapKeysOptions[16]
  mapAccelerators[32] = mapKeysOptions[17]
  mapAccelerators[33] = mapKeysOptions[18]
