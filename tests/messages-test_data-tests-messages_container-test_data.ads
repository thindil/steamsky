...
package Messages.Test_Data.Tests.Messages_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Messages.Messages_Container.Test_Data (Test);
...
end Messages.Test_Data.Tests.Messages_Container.Test_Data;
