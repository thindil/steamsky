...
let defaultTheme = ThemeRecord(name: "Default theme", fileName: dataDirectory & DirSep & "ui" & DirSep & "theme.tcl", enemyShipIcon: "\uf51c", attackOnBaseIcon: "\uf543", diseaseIcon: "\uf5a6", doublePriceIcon: "\uf0d6", fullDocksIcon: "\uf057", enemyPatrolIcon: "\uf51b", traderIcon: "\uf197")
