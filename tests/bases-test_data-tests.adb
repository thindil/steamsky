...
--  end read only
--  begin read only
   procedure Wrap_Test_GainRep_6338e6_901e58 (BaseIndex: Bases_Range; Points: Integer) 
   is
   begin
...
--  id:2.2/6338e6483a422dde/GainRep/1/0/test_gainrep/
   ...
   procedure GainRep (BaseIndex: Bases_Range; Points: Integer) renames Wrap_Test_GainRep_6338e6_901e58;
--  end read only
