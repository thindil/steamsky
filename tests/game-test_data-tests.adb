...
--  end read only
--  begin read only
   procedure Wrap_Test_Update_Game_25a566_5306b6 (Minutes: Positive; In_Combat: Boolean := False) 
   is
   begin
      GNATtest_Generated.GNATtest_Standard.Game.Update_Game (Minutes, In_Combat);
   end Wrap_Test_Update_Game_25a566_5306b6;
--  end read only

--  begin read only
   procedure Test_Update_Game_test_updategame (Gnattest_T : in out Test);
   procedure Test_Update_Game_25a566_5306b6 (Gnattest_T : in out Test) renames Test_Update_Game_test_updategame;
--  id:2.2/25a566d308fb13f6/Update_Game/1/0/test_updategame/
   ...
   procedure Update_Game (Minutes: Positive; In_Combat: Boolean := False) renames Wrap_Test_Update_Game_25a566_5306b6;
--  end read only
...
--  begin read only
   procedure Wrap_Test_End_Game_29871f_745ef4 (Save: Boolean) 
   is
   begin
...
--  begin read only
   ...
   procedure Test_End_Game_29871f_745ef4 (Gnattest_T : in out Test) renames Test_End_Game_test_endgame;
--  id:2.2/29871f76a299de21/End_Game/1/0/test_endgame/
   procedure Test_End_Game_test_endgame (Gnattest_T : in out Test) is
   procedure End_Game (Save: Boolean) renames Wrap_Test_End_Game_29871f_745ef4;
--  end read only
...
--  begin read only
   function Wrap_Test_Find_Skill_Index_2a5948_bcc9a6 (Skill_Name: Unbounded_String)  return Natural
   is
   begin
      begin
         pragma Assert
           (Skill_Name /= Null_Unbounded_String);
         null;
      exception
      ...
      declare
         Test_Find_Skill_Index_2a5948_bcc9a6_Result : constant Natural := GNATtest_Generated.GNATtest_Standard.Game.Find_Skill_Index (Skill_Name);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   procedure Test_Find_Skill_Index_test_findskillindex (Gnattest_T : in out Test);
   procedure Test_Find_Skill_Index_2a5948_bcc9a6 (Gnattest_T : in out Test) renames Test_Find_Skill_Index_test_findskillindex;
--  id:2.2/2a5948be5170f7b8/Find_Skill_Index/1/0/test_findskillindex/
   procedure Test_Find_Skill_Index_test_findskillindex (Gnattest_T : in out Test) is
      function Find_Skill_Index (Skill_Name: Unbounded_String) return Natural renames Wrap_Test_Find_Skill_Index_2a5948_bcc9a6;
--  end read only
