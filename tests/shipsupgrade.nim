...
suite "Unit tests for shipsupgrade module":
  ...
  playerShip.cargo = @[]
  playerShip.cargo.add(y = initInventoryData(protoIndex = 61, amount = 5, durability = 100))
  playerShip.cargo.add(y = initInventoryData(protoIndex = 5, amount = 100, durability = 100))
  playerShip.crew = @[]
