...
package Goals.Test_Data.Tests.Goals_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Goals.Goals_Container.Test_Data (Test);
...
end Goals.Test_Data.Tests.Goals_Container.Test_Data;
