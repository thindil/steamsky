...
package Factions.Test_Data.Tests.Careers_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Factions.Careers_Container.Test_Data (Test);
...
end Factions.Test_Data.Tests.Careers_Container.Test_Data;
