...
proc moveShipCommand(clientData: cint; interp: PInterp; argc: cint;
  ...
  of 6:
    showQuestion(question = "You don't have an pilot on duty. Do you want to wait until your pilot rest?",
        res = "nopilot")
    return tclOk
  # Ship moved, but engineer needs rest, confirm
  of 7:
    showQuestion(question = "You don't have a engineer on duty. Do you want to wait until your engineer rest?",
        res = "nopilot")
    return tclOk
