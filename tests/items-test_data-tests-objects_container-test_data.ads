...
package Items.Test_Data.Tests.Objects_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Items.Objects_Container.Test_Data (Test);
...
end Items.Test_Data.Tests.Objects_Container.Test_Data;
