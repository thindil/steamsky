...
package Crafts.Test_Data.Tests.Recipes_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Crafts.Recipes_Container.Test_Data (Test);
...
end Crafts.Test_Data.Tests.Recipes_Container.Test_Data;
