...
package Stories.Test_Data.Tests.StepData_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Stories.StepData_Container.Test_Data (Test);
...
end Stories.Test_Data.Tests.StepData_Container.Test_Data;
