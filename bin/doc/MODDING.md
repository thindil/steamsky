...
* Inside help text you can use special variables which later will be replaced
  ...
  where `[number]` is between 1 and 28 (example: `{GameKey 9}`). Proper game
  ...
  show know bases, show known events, show accepted missions, show know
  stories, move map position, show game statistics, show help, show game
  options, quit from game, resign from game, show menu, show wait orders,
