   ...
   procedure Test_UpdateDestroyedShips_test_updatedestroyedships
     (Gnattest_T: in out Test) is
      procedure UpdateDestroyedShips
        (ShipName: Unbounded_String) renames
...
--  begin read only
   ...
   procedure Test_ClearGameStats_97edec_31f9dd
     (Gnattest_T: in out Test) renames
   ...
   procedure Test_UpdateFinishedGoals_test_updatefinishedgoals
     (Gnattest_T: in out Test) is
      procedure UpdateFinishedGoals
        (Index: Unbounded_String) renames
   ...
   procedure Test_UpdateFinishedMissions_test_updatefinishedmissions
     (Gnattest_T: in out Test) is
      procedure UpdateFinishedMissions
        (MType: Unbounded_String) renames
   ...
   procedure Test_UpdateKilledMobs_test_updatekilledmobs
     (Gnattest_T: in out Test) is
      procedure UpdateKilledMobs
        (Mob: Member_Data;
         FractionName: Unbounded_String) renames
