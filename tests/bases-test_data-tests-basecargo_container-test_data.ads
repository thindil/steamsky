...
package Bases.Test_Data.Tests.BaseCargo_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Bases.BaseCargo_Container.Test_Data (Test);
...
end Bases.Test_Data.Tests.BaseCargo_Container.Test_Data;
