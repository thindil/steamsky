...
proc hasSelection(): bool {.raises: [], tags: [].} =
...
proc updateTooltips() {.raises: [], tags: [].} =
...
proc getAdaHighestSkill(memberIndex: cint): cstring {.raises: [], tags: [WriteIOEffect, TimeEffect], exportc.} =
  try:
...
proc setAdaAvailableOrders(memberIndex: cint; ordersBox,
    button: cstring) {.raises: [], tags: [WriteIOEffect, TimeEffect], exportc.} =
  try:
