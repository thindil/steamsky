      ...
      begin
         ...
         Ada_Ship.Name :=
           Tiny_String.To_Bounded_String
             (Source => Value(Item => Nim_Ship.Name));
      ...
      begin
         ...
         for Module of Nim_Modules loop
            ...
            declare
               ...
               M_Type: constant Module_Type_2 :=
                 Module_Type_2'Val(Module.M_Type);
            --## rule off IMPROPER_INITIALIZATION
                  ...
                  when ENGINE =>
                     Temp_Module :=
                       (M_Type => ENGINE,
                        ...
                        Upgrade_Progress => Module.Upgrade_Progress,
                        Upgrade_Action =>
                          Ship_Upgrade'Val(Module.Upgrade_Action),
                        Owner => Owners, Power => Module.Data(2),
                        Fuel_Usage => Module.Data(1),
                        Disabled =>
                          (if Module.Data(3) = 1 then True else False));
                  when CABIN =>
                     Temp_Module :=
                       (M_Type => CABIN,
                        Name =>
