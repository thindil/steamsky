...
pack [ttk::button .mainmenu.about -text {About} -underline 0 -command {bind . <Alt-s> {InvokeButton .aboutmenu.showlicense}; bind . <Alt-b> {InvokeButton .aboutmenu.back}; bind . <Escape> {InvokeButton .aboutmenu.back}; pack forget .mainmenu; pack .aboutmenu -fill both -expand true}]
...
grid [ttk::button .aboutmenu.website -text {Website} -style Toolbutton] -row 1 -columnspan 3
grid [ttk::button .aboutmenu.mail -text {(c)2016-2020 Bartek thindil Jasicki} -style Toolbutton] -row 2 -columnspan 3
...
grid [ttk::button .aboutmenu.back -text {Back to main menu} -underline 0 -command {bind . <Alt-s> {}; bind . <Alt-b> {}; bind . <Escape> {}; pack forget .aboutmenu; pack .mainmenu -fill both -expand true}] -row 6 -column 2 -sticky e
