...
* Key `ArrowUpLeftIcon`: Path to the SVG image which will be used on button
  to move the player's ship up and left. Optional.
...
* Key `MapArrowUpLeftIcon`: Path to the SVG image which will be used on button
  to move map up and left. Optional.
* Key `MapArrowUpRightIcon`: Path to the SVG image which will be used on button
  to move map up and right. Optional.
* Key `MapArrowUpIcon`: Path to the SVG image which will be used on button to
...
* Key `MapArrowDownLeftIcon`: Path to the SVG image which will be used on button
