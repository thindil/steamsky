...
package Ships.Test_Data.Tests.ProtoCrew_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Ships.ProtoCrew_Container.Test_Data (Test);
...
end Ships.Test_Data.Tests.ProtoCrew_Container.Test_Data;
