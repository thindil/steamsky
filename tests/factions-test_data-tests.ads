...
package Factions.Test_Data.Tests is
   ...
   --  factions.ads:188:4:GetReputation:Test_GetReputation

   procedure Test_IsFriendly_868bec_b689c9(Gnattest_T: in out Test);
   --  factions.ads:205:4:IsFriendly:Test_IsFriendly

   procedure Test_GetRandomFaction_47dd81_103989(Gnattest_T: in out Test);
   --  factions.ads:219:4:GetRandomFaction:Test_GetRandomFaction
