...
bind $crewframe.info.priorities.level2 <<ComboboxSelected>> {SetPriority 2 [$crewframe.info.priorities.level2 current]}
...
bind $crewframe.info.priorities.level3 <<ComboboxSelected>> {SetPriority 3 [$crewframe.info.priorities.level3 current]}
...
bind $crewframe.info.priorities.level4 <<ComboboxSelected>> {SetPriority 4 [$crewframe.info.priorities.level4 current]}
...
bind $crewframe.info.priorities.level5 <<ComboboxSelected>> {SetPriority 5 [$crewframe.info.priorities.level5 current]}
...
bind $crewframe.info.priorities.level6 <<ComboboxSelected>> {SetPriority 6 [$crewframe.info.priorities.level6 current]}
...
bind $crewframe.info.priorities.level7 <<ComboboxSelected>> {SetPriority 7 [$crewframe.info.priorities.level7 current]}
...
bind $crewframe.info.priorities.level8 <<ComboboxSelected>> {SetPriority 8 [$crewframe.info.priorities.level8 current]}
...
bind $crewframe.info.priorities.level9 <<ComboboxSelected>> {SetPriority 9 [$crewframe.info.priorities.level9 current]}
...
bind $crewframe.info.priorities.level10 <<ComboboxSelected>> {SetPriority 10 [$crewframe.info.priorities.level10 current]}
...
bind $crewframe.info.priorities.level11 <<ComboboxSelected>> {SetPriority 11 [$crewframe.info.priorities.level11 current]}
...
bind $crewframe.info.priorities.level12 <<ComboboxSelected>> {SetPriority 12 [$crewframe.info.priorities.level12 current]}
# Options
grid [ttk::button $crewframe.info.inventory -text {Inventory}]
grid [ttk::button $crewframe.info.dismiss -text {Dismiss} -command Dismiss]
