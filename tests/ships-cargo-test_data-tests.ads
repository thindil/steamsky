...
package Ships.Cargo.Test_Data.Tests is
   ...
   procedure Test_UpdateCargo_331188_53988c(Gnattest_T: in out Test);
   ...
   --  ships-cargo.ads:75:4:GetItemAmount:Test_GetItemAmount

   procedure Test_GetItemsAmount_df8553_e4797c(Gnattest_T: in out Test);
   --  ships-cargo.ads:88:4:GetItemsAmount:Test_GetItemsAmount
