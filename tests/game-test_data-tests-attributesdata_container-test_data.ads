...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Game.AttributesData_Container.Test_Data (Test);
...
end Game.Test_Data.Tests.AttributesData_Container.Test_Data;
