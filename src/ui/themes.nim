...
let
  ...
  defaultTheme*: ThemeData = ThemeData(name: "Default theme",
      ...
      colors: [backgroundColor: "#1a130c".parseColor,
          ...
          "#291913".parseColor, "#500000".parseColor, "#120d0d".parseColor,
          "#ffdf00".parseColor, "#120d0d".parseColor, "#372412".parseColor,
          "#1a130c".parseColor, "#120d0d".parseColor, "#120d0d".parseColor,
          "#ffdf00".parseColor, "#372412".parseColor, "#ffdf00".parseColor,
          "#ffdf00".parseColor, "#7f8c8d".parseColor, "#000000".parseColor,
          "#006400".parseColor, "#458588".parseColor, "#4e9a06".parseColor,
          "#ffdf00".parseColor, "#ffdf00".parseColor, "#372412".parseColor,
          "#500000".parseColor, "#4e9a06".parseColor, "#ffdf00".parseColor,
          "#fb4934".parseColor, "#7f8c8d".parseColor, "#000000".parseColor,
          "#b16286".parseColor, "#d79921".parseColor, "#458588".parseColor,
          "#00ffff".parseColor, "#7f8c8d".parseColor, "#120d0d".parseColor,
          "#eee8aa".parseColor, "#120d0d".parseColor, "#ffdf00".parseColor,
          "#500000".parseColor, "#4e9a06".parseColor, "#00ff00".parseColor],
