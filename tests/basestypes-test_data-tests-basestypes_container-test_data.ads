...
package BasesTypes.Test_Data.Tests.BasesTypes_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.BasesTypes.BasesTypes_Container.Test_Data (Test);
...
end BasesTypes.Test_Data.Tests.BasesTypes_Container.Test_Data;
