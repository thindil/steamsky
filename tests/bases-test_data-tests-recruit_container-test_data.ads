...
package Bases.Test_Data.Tests.Recruit_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Bases.Recruit_Container.Test_Data (Test);
