...
package body Crew.UI is
   ...
   function Show_Member_Info_Command
     (ClientData: in Integer; Interp: in Tcl.Tcl_Interp;
      ...
      MemberFrame, Frame, CrewFrame: Ttk_Frame;
   ...
   begin
      ...
      CrewFrame.Name := New_String(".paned.crewframe");
   ...
   begin
      ...
      if Show_Member_Info_Command
          (ClientData, Interp, 2, CArgv.Empty & "ShowMemberInfo" & "1") /=
        TCL_OK then
         raise SteamSky_Crew_Exception with "Can't show player character info";
      end if;
      return TCL_OK;
