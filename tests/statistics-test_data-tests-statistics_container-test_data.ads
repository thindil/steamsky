...
package Statistics.Test_Data.Tests.Statistics_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Statistics.Statistics_Container.Test_Data (Test);
...
end Statistics.Test_Data.Tests.Statistics_Container.Test_Data;
