...
package Factions.Test_Data.Tests.BaseType_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Factions.BaseType_Container.Test_Data (Test);
