...
package Events.Test_Data.Tests.Events_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Events.Events_Container.Test_Data (Test);
...
end Events.Test_Data.Tests.Events_Container.Test_Data;
