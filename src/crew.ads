...
-- ****
   ...
   -- SOURCE
   Male_Vocals: SyllableString_Container.Vector (Capacity => 128);
   -- ****
   ...
   -- SOURCE
   Male_Consonants: SyllableString_Container.Vector (Capacity => 128);
   -- ****
   ...
   -- SOURCE
   Female_Syllables_Start: SyllableString_Container.Vector (Capacity => 128);
   -- ****
   ...
   -- SOURCE
   Female_Syllables_Middle: SyllableString_Container.Vector (Capacity => 128);
   -- ****
