...
let
  ...
  defaultTheme*: ThemeData = ThemeData(name: "Default theme",
      ...
      "destination.svg", defaultThemeIconPath & "mapmenu.svg"],
      colors: [backgroundColor: "#1a130c".parseColor, foregroundColor: "#eee8aa".parseColor, greenColor: "#4e9a06".parseColor, borderColor: "#372412".parseColor, buttonColor: "#291913".parseColor, buttonHoverColor: "#500000".parseColor, editColor: "#120d0d".parseColor, editCursorColor: "#ffdf00".parseColor, buttonActiveColor: "#120d0d".parseColor, headerColor: "#372412".parseColor, comboColor: "#1a130c".parseColor, propertyColor: "#120d0d".parseColor, scrollbarColor: "#120d0d".parseColor, buttonTextColor: "#ffdf00".parseColor, scrollbarCursorColor: "#372412".parseColor, editTextColor: "#ffdf00".parseColor, comboTextColor: "#ffdf00".parseColor, tooltipBorderColor: "#7f8c8d".parseColor, tooltipColor: "#000000".parseColor, groupBorderColor: "#006400".parseColor, headerTextColor: "#458588".parseColor, groupTextColor: "#4e9a06".parseColor, selectActiveTextColor: "#ffdf00".parseColor, propertyTextColor: "#ffdf00".parseColor, toggleColor: "#372412".parseColor, toggleHoverColor: "#500000".parseColor, toggleCursorColor: "#4e9a06".parseColor, goldenColor: "#ffdf00".parseColor, redColor: "#fb4934".parseColor, mapInfoBorderColor: "#7f8c8d".parseColor, mapInfoColor: "#000000".parseColor, pinkColor: "#b16286".parseColor, yellowColor: "#d79921".parseColor, blueColor: "#458588".parseColor, cyanColor: "#00ffff".parseColor, grayColor: "#7f8c8d".parseColor, tableRowColor: "#120d0d".parseColor, tableTextColor: "#eee8aa".parseColor, sliderEmptyColor: "#120d0d".parseColor, sliderFillColor: "#ffdf00".parseColor, sliderCursorColor: "#500000".parseColor, progressbarColor: "#4e9a06".parseColor, limeColor: "#00ff00".parseColor],
