...
package Game.Test_Data.Tests.SkillsData_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Game.SkillsData_Container.Test_Data (Test);
...
end Game.Test_Data.Tests.SkillsData_Container.Test_Data;
