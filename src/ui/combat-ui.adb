...
package body Combat.UI is
    ...
    begin
        ...
        Change_Attributes(Line => CurrentLine, Column => 2, Count => 5, Color => 1);
        CurrentLine := CurrentLine + 2;
        Move_Cursor(Line => CurrentLine, Column => 2);
        Add(Str => "Crew Info");
        Change_Attributes(Line => CurrentLine, Column => 2, Count => 1, Color => 1);
        CurrentLine := CurrentLine + 1;
        Move_Cursor(Line => CurrentLine, Column => 2);
        Add(Str => "Ship cargo");
        Change_Attributes(Line => CurrentLine, Column => 8, Count => 1, Color => 1);
        CurrentLine := CurrentLine + 1;
        Move_Cursor(Line => CurrentLine, Column => 2);
