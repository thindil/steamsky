...
package Game.Test_Data.Tests.Integer_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Game.Integer_Container.Test_Data (Test);
...
end Game.Test_Data.Tests.Integer_Container.Test_Data;
