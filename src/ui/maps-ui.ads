...
-- ****
   ...
   Map_Accelerators: array(1 .. 37) of Unbounded_String :=
     (1 => To_Unbounded_String(Source => "e"), 2 => To_Unbounded_String(Source => "v"),
      3 => To_Unbounded_String(Source => "plus"), 4 => To_Unbounded_String(Source => "minus"),
      5 => To_Unbounded_String(Source => "KP_Home"), 6 => To_Unbounded_String(Source => "KP_Up"),
      7 => To_Unbounded_String(Source => "KP_Prior"), 8 => To_Unbounded_String(Source => "KP_Left"),
      9 => To_Unbounded_String(Source => "KP_Begin"), 10 => To_Unbounded_String(Source => "KP_Right"),
      11 => To_Unbounded_String(Source => "KP_End"), 12 => To_Unbounded_String(Source => "KP_Down"),
      13 => To_Unbounded_String(Source => "KP_Next"), 14 => To_Unbounded_String(Source => "KP_Divide"),
      15 => To_Unbounded_String(Source => "Shift-Return"), 16 => To_Unbounded_String(Source => "Shift-h"),
      17 => To_Unbounded_String(Source => "Shift-KP_7"), 18 => To_Unbounded_String(Source => "Shift-KP_8"),
      19 => To_Unbounded_String(Source => "Shift-KP_9"), 20 => To_Unbounded_String(Source => "Shift-KP_4"),
