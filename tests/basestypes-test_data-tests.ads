...
package BasesTypes.Test_Data.Tests is
   ...
   procedure Test_Is_Buyable_54f6fa_bdfcfd(Gnattest_T: in out Test);
   --  basestypes.ads:109:4:Is_Buyable:Test_Is_Buyable

   procedure Test_Get_Price_0b9ff9_a670e2(Gnattest_T: in out Test);
   --  basestypes.ads:128:4:Get_Price:Test_Get_Price
