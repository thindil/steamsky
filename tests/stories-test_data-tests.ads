...
package Stories.Test_Data.Tests is
   ...
   --  stories.ads:302:4:Start_Story:Test_StartStory

   procedure Test_Clear_Current_Story_40d661_0d61b8(Gnattest_T: in out Test);
   --  stories.ads:312:4:Clear_Current_Story:Test_ClearCurrentStory

   procedure Test_Progress_Story_323e5c_14aed6(Gnattest_T: in out Test);
   --  stories.ads:326:4:Progress_Story:Test_ProgressStory

   procedure Test_Get_Current_Story_Text_893370_8f71b5
     (Gnattest_T: in out Test);
   --  stories.ads:336:4:Get_Current_Story_Text:Tets_GetCurrentStoryText

   procedure Test_Get_Step_Data_551f39_456123(Gnattest_T: in out Test);
   --  stories.ads:349:4:Get_Step_Data:Test_GetStepData

   procedure Test_Get_Story_Location_5f0f68_b0f396(Gnattest_T: in out Test);
   --  stories.ads:365:4:Get_Story_Location:Test_GetStoryLocation
