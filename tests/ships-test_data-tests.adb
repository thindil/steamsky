...
--  end read only
--  begin read only
   function Wrap_Test_CreateShip_c5e851_13521c (ProtoIndex, Name: Unbounded_String; X: Map_X_Range; Y: Map_Y_Range; Speed: ShipSpeed; RandomUpgrades: Boolean := True)  return ShipRecord
   is
   begin
      begin
         pragma Assert
      ...
      declare
         Test_CreateShip_c5e851_13521c_Result : constant ShipRecord := GNATtest_Generated.GNATtest_Standard.Ships.CreateShip (ProtoIndex, Name, X, Y, Speed, RandomUpgrades);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_CreateShip_c5e851_13521c (Gnattest_T : in out Test) renames Test_CreateShip_test_createship;
--  id:2.2/c5e851ac0c40246a/CreateShip/1/0/test_createship/
   procedure Test_CreateShip_test_createship (Gnattest_T : in out Test) is
      function CreateShip (ProtoIndex, Name: Unbounded_String; X: Map_X_Range; Y: Map_Y_Range; Speed: ShipSpeed; RandomUpgrades: Boolean := True) return ShipRecord renames Wrap_Test_CreateShip_c5e851_13521c;
--  end read only
...
--  begin read only
   procedure Wrap_Test_DamageModule_0d948a_8bb198 (Ship: in out ShipRecord; ModuleIndex: Modules_Container.Extended_Index; Damage: Positive; DeathReason: String) 
   is
   begin
      begin
         pragma Assert
           (ModuleIndex in Ship.Modules.First_Index .. Ship.Modules.Last_Index);
         null;
      exception
         when System.Assertions.Assert_Failure =>
            AUnit.Assertions.Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Ships.DamageModule (Ship, ModuleIndex, Damage, DeathReason);
      begin
         pragma Assert
           (True);
         null;
   ...
   end Wrap_Test_DamageModule_0d948a_8bb198;
--  end read only

--  begin read only
   procedure Test_DamageModule_test_damagemodule (Gnattest_T : in out Test);
   procedure Test_DamageModule_0d948a_8bb198 (Gnattest_T : in out Test) renames Test_DamageModule_test_damagemodule;
--  id:2.2/0d948a4ee9f63a43/DamageModule/1/0/test_damagemodule/
   ...
   procedure DamageModule (Ship: in out ShipRecord; ModuleIndex: Modules_Container.Extended_Index; Damage: Positive; DeathReason: String) renames Wrap_Test_DamageModule_0d948a_8bb198;
--  end read only
